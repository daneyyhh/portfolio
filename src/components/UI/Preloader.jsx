...
export default function Preloader({ onComplete }) {
  ...
  return (
    ...
    >
      {/* Pre-loader Hierarchy */}
      <div className="flex flex-col items-center justify-center text-center space-y-8 w-full max-w-xl my-auto z-10">
        
        {/* 1. LARGE REUBG LOGO (380px–480px on Desktop, Clean without any glow box) */}
        <motion.div
          animate={phase === 'completing' ? { scale: [1, 1.03, 1] } : { scale: 1 }}
          transition={{ duration: 0.4 }}
          className="flex justify-center"
        >
          <ReubgLogo className="w-[clamp(280px,32vw,480px)] h-auto object-contain" />
        </motion.div>
