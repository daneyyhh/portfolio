            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                    <motion.div 
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-sm text-red-400 font-semibold tracking-widest uppercase mb-3">Capabilities</h2>
                    ...
                    {skills.map((skill, i) => (
                        ...
                        >
                            <div className="flex justify-between items-end mb-3">
                                ...
                                <span className="text-sm text-red-400 font-medium font-outfit">{skill.level}%</span>
                            </div>
