...
const Contact = () => {
    return (
        <section id="contact" style={{ padding: '100px 40px', background: 'var(--comic-gray)' }} data-bg="#ffde00">
            <div style={{ maxWidth: '800px', margin: '0 auto', background: '#fff', border: '4px solid #000', padding: '40px', boxShadow: '15px 15px 0px #000' }}>
                <div style={{ marginBottom: '40px' }}>
                    ...
                    <h2 className="section-title reveal-text" data-text="CONTACT" style={{ fontSize: '4rem', color: '#000' }}>CONTACT</h2>
                </div>
                ...
                <form style={{ display: 'grid', gap: '20px' }}>
                    ...
                    <textarea
                        ...
                        style={{ border: '3px solid #000', padding: '15px', fontFamily: 'var(--font-body)', outline: 'none' }}
                    />
                    <button className="btn-comic magnetic" style={{ width: '100%', fontSize: '1.8rem' }}>SEND TRANSMISSION</button>
                </form>
